/**
 * Vision Component
 * Represents "Future Protocol: The Agent Economy".
 */
export const Vision = () => {
    return `
    <div id="vision" class="tokenomics-banner">
        ...
        <div class="runic-glyph">ᛊ ᛫ ᛟ ᛫ ᚹ ᛫ ᛚ</div>
        <br>
        <a href="#whitepaper" class="btn btn-secondary">Read the Whitepaper</a>
        <a href="https://pump.fun/coin/7zwfQkkPv9aUF6VXA8CbZabJYpXCRJTYbQnjxjynpump" target="_blank" class="btn btn-primary" style="margin-left: 1rem;">View $FAI on Pump.fun</a>
    </div>
    `;
};
