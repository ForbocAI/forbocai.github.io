            ...
            <div class="servitor-body">
                ...
                <div class="servitor-prose">
                    ...
                    <figure class="divergence">
                        ...
                        <p class="divergence-note">Two different actions from one scene. A prompt can do that once. Run the same two characters forty turns deep with a player leaning on them the whole way, and a prompted persona drifts — toward agreeableness, toward the house voice underneath it. Every general-purpose model we have tried this on does, including ones better than ours at conversation. What a release is measured on is how far apart the profiles still are at the end of that. So do not take it on our word, and do not take the easy half of it either: the scene above is three minutes from the CLI, and it is turn one, which a prompt can also pass. The run that settles anything is the long one — forty turns, two profiles, a world you supply, both transcripts side by side for your writers to read rather than for us to score. That is the run our own qualification does. Ask for it on the first call.</p>
                    </figure>
