...
export const Servitor = () => {
    ...
    <section id="servitor" class="chapter chapter-day servitor">
        <div class="container">
            ...
            <p class="servitor-moat">Every other layer of an NPC stack is a quarter's work for a competent team. A model that composes into sixteen minds, holds a world it was never trained on, and refuses to invent its way out of a gap is not a quarter's work at any headcount, because the work is sequential: each release is qualified against the bar the last one cleared, and you cannot hire your way past a gate you have not built yet. That is the part of ForbocAI that compounds, and it is the part a competitor cannot reach by wiring up somebody else's API.</p>
        </div>
    </section>
    `;
};
