...
export const App = (state) => {
    ...
    <div class="tech-layer">
        <span class="diagnostic-label diagnostic-flicker" data-macro-scramble data-text="ENV.STABLE // FORBOC.V1" style="top: 2rem; right: 2rem; position: fixed;">ENV.STABLE // FORBOC.V1</span>
