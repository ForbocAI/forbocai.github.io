        ...
        <div class="container">
            <header class="chapter-head">
                ...
                <div>
                    ...
                    <p class="chapter-lead"><strong>This is not a proposal for a world that might exist.</strong> Servitor™ is reasoning inside one right now. The Protocol is the law she enters it through. The eighteen gates between here and production authority are numbered and public, because a category being settled from the inside can afford to publish its own itinerary. You are reading it from the outside.</p>
                </div>
            </header>
            ...
            <p class="investors-takeaway">Servitor™ is the intelligence. The ForbocAI NPC Protocol is the law she enters through. Together they are the medium, and the first casts are being authored in it now. Eighteen questions are open, numbered, and published in the whitepaper. The one no list can answer for you is whose cast this is.</p>
