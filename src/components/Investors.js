    ...
    <section id="investors" class="chapter chapter-night investors-section">
        ...
        <div class="container">
            ...
            <div class="investors-body">
                ...
                <p>A studio with a budget can fine-tune an open model on its own character documents, and some will. What they get is that studio's cast, on that studio's data, frozen at that studio's last training run — a house voice of their own making, and a machine-learning team to staff forever. We are not selling them a shortcut to it. We are the layer underneath every cast, improving for all of them at once, measured against a standard their own competitors are graded on.</p>
