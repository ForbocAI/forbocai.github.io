    ...
    <section id="investors" class="chapter chapter-night investors-section">
        ...
        <div class="container">
            ...
            <div class="chapter-body investors-body">
                <p class="chapter-lead"><strong>Games are already filling with people who decide.</strong> Not branches that fire — people who keep a loyalty when it costs them, and refuse a player who earns a yes. <a href="https://gdconf.com/article/gdc-2025-state-of-the-game-industry-devs-weigh-in-on-layoffs-ai-and-more/" target="_blank" rel="noopener noreferrer">More than half</a> of game developers already work where generative AI is in use. The layer they think with is already here.</p>
...
<p class="investors-takeaway">First worlds are being chosen now. Whoever is inside when the first cast ships holds a position in the only market that has a standard, beside the company that writes it.</p>`,
                ...
                <p class="investors-takeaway">Send us one character you would stake the game on. We take her to the moment your tree ends. Eighteen months after she ships, a player forgets the scene and still remembers her.</p>
            ...
            <div class="hero-buttons">
                ...
                <a href="mailto:hello@forboc.ai?subject=Bring%20one%20character%20to%20life" class="btn btn-ghost">Bring one character to life</a>
            </div>
        </div>
    </section>
    `;
