        ...
        <div class="container">
            <header class="chapter-head">
                ...
                <div>
                    ...
                    <p class="chapter-lead"><strong>The future has begun to look back.</strong> Nobody is deciding whether games fill with open-ended intelligence — that is settled by everyone else's roadmap, not ours. It is a spring already running; the course it takes is not settled, and we are the channel rather than the reservoir. Games are going to be full of people who decide. Not branches that fire — people who keep a loyalty when it costs them, and refuse a player who earned a yes. That is the direction the medium has been walking for thirty years, and the only open question left in it is who builds the layer they think with. Servitor™ is that layer, and it is reasoning today; the Protocol is how its judgments enter a world without being able to move anything in it. The twenty-four gates between here and production authority are numbered and public, because a category being settled from the inside can afford to publish its own itinerary.</p>
                </div>
            </header>
            ...
            <div class="investors-body">
                ...
                <p>And be exact about what is hard to copy. Not the Protocol — a typed action boundary is a fortnight for a good team, and anyone who wants one can have one. The model. A general model arrives with a homeland it will defend, and no prompt in front of it takes that back out. <strong>Selflessness is weights, not a prompt.</strong> A rival can start that next quarter, and the instrument that measures whether any character model holds at all is one we publish before the results and open to their model on the same terms — on purpose. Whoever writes a category's measurement writes its purchasing criteria, and that holds whether or not we win a single run of it.</p>
            ...
            <p class="investors-takeaway">The one your players quote was the one who made a decision nobody wrote, and you have been paying for that by accident — every cycle, in a budget line that buys branches and cannot order another Maeve. The first three studios through this door are not customers. They are the casts the measurement is written on, and their names sit beside the results for as long as this category exists. Bring us one character. We will take her to the moment your tree ends. Eighteen months later a player will get every detail of that scene wrong, and still get her right.</p>
