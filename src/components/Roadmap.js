    ...
    <div id="roadmap" class="roadmap-section">
        ...
        <div class="grid">
            <div class="card">
                ...
                <span class="runic" data-macro-scramble data-text="Córtex_Init">Córtex_Init</span>
                <h3>The Cortex</h3>
            ...
            <div class="card">
                ...
                <span class="runic" data-macro-scramble data-text="Bridge_Protocol">Bridge_Protocol</span>
            ...
            <div class="card">
                ...
                <span class="runic" data-macro-scramble data-text="Æconomy_Scále">Æconomy_Scále</span>
