...
export const Turn = () => {
  ...
  constraints: ['The letter does not open on a debt. Only on news of Aldren.'],
                ...
                <p class="turn-note turn-authored-foot"><em>The letter does not open on a debt</em> is a writer's constraint, typed on a Tuesday. What it costs her at the counter, at night, with this particular player in front of her, is <em>that earns the road, it does not earn the letter</em>. Nobody typed the second one — and your writer authored the half that decided it.</p>
            </div>
