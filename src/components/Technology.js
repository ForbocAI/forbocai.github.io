        ...
        <div class="container">
            ...
            <ul class="ledger">
                ...
                <li class="ledger-row">
                    ...
                    <p class="ledger-fact">We do not classify what a character says for your ratings board, and we do not claim console-certification readiness. A player working to make her say something ugly is the same risk you already carry for player-facing text, and it stays yours, because the submission is yours and so is the territory list. If your rating needs generated lines classified before a player sees them, that classifier goes in front of us on your side of the boundary — the same side your validation rules already live on. It is the question we get asked latest and the one that should be asked first, so ask it on the first call.</p>
                </li>
