...
export const Technology = () => {
    ...
    <section id="technology" class="chapter chapter-day">
        <div class="container">
            ...
            <ul class="ledger">
                ...
                <li class="ledger-row">
                    <div class="ledger-body">
                        ...
                        <p>Everything above keeps a character in character under pressure. None of it is a content policy, and we are not going to let the two be read as the same thing. Model output is structurally validated and cannot authorize a game action unless your rules accept it — that is canon integrity and gameplay legality, and that is where it stops.</p>
                    </div>
                    <p class="ledger-fact">We do not classify what a character says for your ratings board, and we do not claim console-certification readiness. A player working to make her say something ugly produces a line a platform holder will read as yours, not as theirs — that is a harder problem than a chat box, and pretending otherwise would only waste your first call. It stays with you because the submission is yours and so is the territory list. If your rating needs generated lines classified before a player sees them, that classifier sits between our answer and your renderer, on your side of the boundary — the same side your validation rules already live on, and the same place they already run. It is the question we get asked latest and the one that should be asked first, so ask it on the first call.</p>
                </li>
                ...
                <li class="ledger-row">
                    ...
                    <p>What it costs is shaped like this — plans priced by request volume rather than by tokens spoken, metered at the check. The moment a character asks to change your world is the moment worth counting, and it is the same moment your build already audits. A turn that comes back invalid is not a request you paid for, and a turn where she only talks and proposes nothing still passes the check. The numbers come on the call; the shape does not change between here and there.</p>
            ...
            <div class="ledger-note"><p><strong>And if we are not here in three years?</strong> It is the right question to ask a seed-stage company selling hosted cognition, and we are not going to answer it with a slogan. What is already true: your memory store is yours and readable without us, your validation rules never left your build, and nothing in your save file depends on us having answered.</p>
            ...
            <p>That fallback is not free, and we are not going to price it at zero for you. Shipping on us means authoring a bark floor for every character a player can reach — not the first handful of lines you would have written regardless, but a deliberate pass across all of them, costed as its own milestone. What you stop writing is the long tail. What you keep writing is the floor you fall to, and it belongs in the budget as insurance rather than arriving later as a surprise.</p>

            <p>Continuity beyond that is contractual rather than technical, and we will not promise on a marketing page what only a signature can bind: ask on the first call, not in month three. We will not claim an offline fallback we have not built either.</p></div>
        </div>
    </section>
    `;
};
