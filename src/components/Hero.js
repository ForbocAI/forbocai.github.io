    ...
    <section class="hero-container">
        <div class="hero">
            ...
            <div class="hero-content">
                ...
                <h1><span class="gradient-text">Lantern-Lit Worlds.</span><br>Living Souls.</h1>
                <p>ForbocAI, Inc. helps studios raise companions, neighbors, and NPCs that remember who they have met and who they are becoming. Beneath the lantern glow sits the whole garden: ghost scouts walking the roads ahead, portable Souls, and the <strong>$FAI</strong> market path that lets living characters keep growing beyond a single save file or world.</p>
