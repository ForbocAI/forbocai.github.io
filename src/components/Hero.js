    ...
    <section class="hero">
        <div class="container hero-grid">
            <div class="hero-copy">
                ...
                <p class="hero-engines"><strong>The ForbocAI NPC Protocol is how that intelligence enters a world without being able to change your state.</strong> Servitor™ proposes; your game alone makes it real. Be exact about which half of the worry that settles: she cannot move your state, and she can still say something about your world that is not true. That second one is gate twelve, and we print an example of it on our own demo further down. The first is what turns an open-ended model into a cast you can ship.</p>
