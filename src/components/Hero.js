    ...
    <section class="hero">
        <div class="container hero-grid">
            <div class="hero-copy">
                ...
                <p class="hero-engines"><strong>The ForbocAI NPC Protocol is how that intelligence enters a world without being able to change your state.</strong> Servitor™ proposes; your game alone makes it real. That settles one half of the worry and not the other, so be exact about which. She cannot move your state — and that boundary is what turns an open-ended model into a cast you can ship. She can still say something about your world that is not true, which is gate twelve, and we print an example of it in our own demo further down.</p>
