            ...
            <div class="doc-body">
                ...
                <section id="wp-problem">
                    ...
                    <ul>
                        ...
                        <li><strong>Cost.</strong> A model demo says nothing about unit economics at a shipped title's concurrency. What we can state is the shape: one character judgment is one call. The dialogue, the reasoning behind it and the structured action come back from the same attempt — not a chain of calls per line, not a re-roll to get a parseable action, not a second request to explain the first. Concurrency and unit economics are clause four; the call count per decision is not.</li>
                ...
                <section id="wp-layer">
                    ...
                    <p>Studios invoke Servitor™ through the ForbocAI NPC Protocol; the model reasons in ForbocAI infrastructure rather than being packaged as a client runtime. The trade is plain: active cognition requires a network connection, and what a studio keeps if this company stops is clause nine.</p>
                ...
                <section id="wp-souls">
                    ...
                    <p>The Soul layer is designed to carry the history a player and character made together. We are assembling the opt-in record — identity, memory, relationships and temperament — while every receiving title decides what enters.</p>
                    <ul>
