        ...
        <div class="container">
            ...
            <div class="doc-body">
                ...
                <section id="wp-layer">
                    ...
                    <p>Studios invoke Servitor™ through the ForbocAI NPC Protocol; the model reasons in ForbocAI infrastructure rather than being packaged as a client runtime. The trade is plain: active cognition requires a network connection, and what a studio keeps if this company stops is gate nine.</p>
                    ...
                    <p>ForbocAI returns a memory-write instruction. Your build applies it to a local store your studio controls and can read without us. Be exact about what moves, because this is the paragraph your counsel will ask about. Your store never leaves you: it is written by your build, read by your build, and nothing in it is ours. What does leave you is the turn — a memory excerpt drawn from that store, the persona and the world context — because hosted cognition is what is being bought and it cannot reason about what it has not been sent. Excluding that excerpt from training is gate four. Until that contract is signed you have our word and not an instrument, and we would rather you had the instrument — which is exactly why it is a gate and not a sentence. The separate, opt-in Soul path described below would send locally encrypted character ciphertext to a configured storage provider; it is not part of a title that never invokes it.</p>

                    <h3>3.4 Ghost</h3>
                    <p>Procedural and adaptive systems can outrun manually authored test paths. The internal harness already drives test worlds during Servitor™ qualification. Turning those runs into producer-facing reports on dead ends, unreachable content and social-loop coverage is gate ten. No studio outside ForbocAI has run the harness at all, so the only producers reading anything today are ours. Production qualification controls release.</p>
                    ...
                    <p id="wp-gates"><strong>Twenty-four gates stand between here and full production authority, and here they are, with what opens each one.</strong> Each is named once and numbered once, and wherever one of them is disclosed in prose we name its number there too. We publish it because we intend to walk it, and because you should be able to hold us to every line. It has an order, so here is the critical path. Five, six and nine block one, because no publisher signs a shipped integration before outage behavior, platform certification and continuity are instrumented. Two names the alternative that thirteen, fourteen and fifteen are scored against, so it blocks all three. Twenty-three blocks those three as well, because a number measured on a cast we control is not a number. And eleven blocks twenty-four, since a token cannot serve a Soul that has never crossed. And twenty-two blocks twenty-one: nobody adopts a ruler to make a purchase until somebody is purchasing. Nothing has cleared yet. That is the honest scoreboard, and we would rather hand it over than have it found.</p>
                    <ol class="gate-ledger">
                        <li><strong><span class="gate-n">1.</span> External-studio evidence.</strong> Clears when a studio that is not ForbocAI ships a title with Servitor™ in it. Running one in development is what the first three worlds do, and that is how five, six and nine get cleared rather than a way around them.</li>
                        <li><strong><span class="gate-n">2.</span> Named-alternative comparison.</strong> Clears when a public comparison of overall character-judgment quality, against an alternative we name, is published — win or lose. It clears on the publishing, not on the result. It is the broad comparison; thirteen through fifteen are the specific properties measured against the same named alternative, so this gate names the opponent that those three are scored against.</li>
                        ...
                        <li><strong><span class="gate-n">4.</span> Commercial release terms.</strong> Clears when the release contract binds the billable event, the public price, quotas, overage behavior, production capacity, unit economics measured at a shipped title's load rather than a demo's, and both the retention terms and the training-use terms for turn data. To be plain ahead of that contract: the turn carries the persona, the memory excerpt and the world context a studio just sent, and excluding it from training is the term we intend to bind.</li>
                        ...
                        <li><strong><span class="gate-n">9.</span> Continuity if this company stops.</strong> Clears when an instrument exists that keeps a shipped title running without us. Hosted cognition makes this the hardest gate here, and the honest reading is that it means escrowed weights or a licensed runtime — naming that is better than letting the word "instrument" carry it. Which collides with the moat, so we will say which gives: the weights go into escrow, released only on our failure, and what we keep is the instrument and the work of having built it. A studio that needs continuity gets it. A rival who wants the advantage still has to build the measurement, not wait for our bankruptcy.</li>
                        ...
                        <li><strong><span class="gate-n">14.</span> Cast separation.</strong> Clears when a cast of four hundred is measured staying distinct from one another. Holding one authored person under pressure is a different property from keeping four hundred of them apart.</li>
                        ...
                        <li><strong><span class="gate-n">18.</span> Dialogue and action agreement.</strong> Clears when the rate at which a reply promises what the studio's rules then reject is measured and published. An action refused after the line is already spoken is the most common shipped failure of this whole product category.</li>
                        <li><strong><span class="gate-n">19.</span> Per-scene deadlines.</strong> Clears when a studio can set its own budget per scene instead of inheriting one server-side number.</li>
                        <li><strong><span class="gate-n">20.</span> Memory-write validation.</strong> Clears when a memory write is checked against studio rules the way an action already is. Memory is the artifact that persists and shapes every later judgment, and today only the action path is checked.</li>
                        <li><strong><span class="gate-n">21.</span> The measurement as moat.</strong> Clears when a party that is not ForbocAI uses our instrument to make a purchasing decision. A published methodology open to rivals is a standard rather than a secret, and we would not want the other kind: a measurement nobody else will run measures nothing. Whoever writes a category's measurement writes its purchasing criteria, and the honest mechanism is narrow: a publisher adopts a vendor's axes only when they are published before the results, run against a cast the vendor did not author, and open to a rival's model on the same terms. All three are conditions on us, not on them.</li>
                        <li><strong><span class="gate-n">22.</span> A studio pays.</strong> Clears when a studio that is not ForbocAI pays for character judgments in ordinary money. Every other gate here is engineering. This is the one that asks whether anyone buys it.</li>
                        <li><strong><span class="gate-n">23.</span> Independent cast provenance.</strong> Clears when the casts that gates thirteen through fifteen are measured against come from a party with no commercial relationship to ForbocAI, and that party is named beside the result. A persona-hold number measured on a cast we control is one you should discount to nothing, so the independence has to be a gate rather than an assurance.</li>
                        <li><strong><span class="gate-n">24.</span> $FAI utility.</strong> Clears when a Soul is minted, carried and restored using $FAI between two live titles. Until then the token has no product function, and it belongs on this list rather than outside it.</li>
                    </ol>
                ...
                <section id="wp-souls">
                    ...
                    <p><strong>A card preserves who a character is. A Soul carries who she became with you.</strong> Trading cards demonstrate a durable appetite for identity, strategy, collecting and a cast that grows across releases. <a href="https://investor.hasbro.com/magic-gathering" target="_blank" rel="noopener noreferrer">Hasbro reports $1.72&nbsp;billion of 2025 Magic revenue across tabletop and digital, and 17% CAGR since 2009</a>. Read that figure for what it is: one brand, counted across physical and digital, set beside Global Market Insights' sizing of the printed trading-card game market, which counts printed cards only — so Magic's share of that market looks larger than it is. The two numbers measure different things, and neither is a forecast of Soul revenue. What they evidence is the habit — decades of people paying for identity they can keep.</p>
                    <p><a href="https://www.npc.com/" target="_blank" rel="noopener noreferrer">Non-Playable Coin packages collectible identity as a memecoin–NFT hybrid</a>, while <a href="https://whitepaper.virtuals.io/about-virtuals/about-virtuals-protocol.md" target="_blank" rel="noopener noreferrer">Virtuals frames agents as autonomous economic actors</a>. The <a href="https://www.coingecko.com/learn/crypto-narratives" target="_blank" rel="noopener noreferrer">AI-agent token sector</a> has grown steeply across 2025 and 2026 and moved past the novelty of an agent holding a wallet toward payments, verifiable inference and compute. We attach no figure to that on purpose: those numbers are market capitalizations, and setting one beside the annual revenues above would compare two different things in our own favor. What the trend evidences is attention — a market already convinced that a character can be an asset — and attention is not studio demand, product evidence or TAM.</p>
