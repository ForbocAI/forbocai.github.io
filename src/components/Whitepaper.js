        ...
        <div class="container">
            ...
            <div class="doc-body">
                ...
                <section id="wp-souls">
                    ...
                    <p>ForbocAI points that appetite at continuity for the player and authority for every receiving studio, with no game-state action unless that world's rules accept it. Paid access to the ForbocAI NPC Protocol and Servitor™ is the business. This paper asserts no equity, revenue, governance or asset right for $FAI.</p>
                </section>
