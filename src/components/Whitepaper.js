    ...
    <article class="doc">
        <div class="container">
            ...
            <div class="doc-body">
                ...
                <section id="wp-layer">
                    ...
                    <ol class="gate-ledger">
                        ...
                        <li><strong><span class="gate-n">18.</span> Dialogue and action agreement.</strong> Clears when a reply is measured never to promise what the studio's rules then reject. An action refused after the line is already spoken is the most common shipped failure of this whole product category, and it was missing from this list.</li>
                        ...
                        <li><strong><span class="gate-n">21.</span> $FAI utility.</strong> Clears when a Soul is minted, carried and restored using $FAI between two live titles. Until then the token has no product function, and it belongs on this list rather than outside it.</li>
                    </ol>
            ...
            <footer class="doc-foot">
                ...
                <a href="#wp-gates" class="btn btn-primary">Read the twenty-one gates</a>
            </footer>
        </div>
    </article>
    `;
