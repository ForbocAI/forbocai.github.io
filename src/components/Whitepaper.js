        ...
        <div class="container">
            ...
            <div class="doc-body">
                ...
                <section id="wp-layer">
                    ...
                    <p>The reply and any proposed action are checked separately. Transport failures reject the request. A server deadline miss or a reply that fails its required rules returns a typed invalid result. Proposed actions that fail the studio's rules are not applied. None can authorize a memory write or state change, and the game owns the fallback. Factual accuracy, moderation and console certification each open in their own turn.</p>
                    ...
                    <h3>3.4 Ghost</h3>
                    <p>Procedural and adaptive systems can outrun manually authored test paths. Ghost, the internal harness, already drives test worlds during Servitor™ qualification. Its reports on dead ends, unreachable content and social-loop coverage reach producers outside this building as that term opens.</p>
