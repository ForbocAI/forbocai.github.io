...
export const Whitepaper = () => {
    ...
    <section class="whitepaper-content">
        <div class="container">
            ...
            <p class="tech-note"><em>This architecture is built on functional programming principles. For a deeper understanding, explore the <a href="https://github.com/seandinwiddie/lectures/blob/main/index.md" target="_blank">Functional Programming Curriculum</a>—an 18-module course covering Redux patterns, monads, and composition.</em></p>
