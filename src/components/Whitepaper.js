            ...
            <div class="doc-body">
                ...
                <section id="wp-problem">
                    ...
                    <ul>
                        ...
                        <li><strong>Cost.</strong> A model demo says nothing about unit economics at a shipped title's concurrency. The shape is this: one character judgment is one call. The dialogue, the reasoning behind it and the structured action come back from the same attempt — not a chain of calls per line, not a re-roll to get a parseable action, not a second request to explain the first. Concurrency and unit economics arrive with the release terms.</li>
                ...
                <section id="wp-layer">
                    ...
                    <p>Studios invoke Servitor™ through the ForbocAI NPC Protocol; the model reasons in ForbocAI infrastructure rather than being packaged as a client runtime. Active cognition requires a network connection. What a studio’s world holds stays its own — its state and its characters’ local memory. The mind it calls on stays in our keeping.</p>
                    ...
                    <p>ForbocAI returns a memory-write instruction. Your build applies it to a local store your studio controls and can read without us. Here is what moves. Your store never leaves you: it is written by your build, read by your build, and nothing in it is ours. What does leave you is the turn — a memory excerpt drawn from that store, the persona and the world context — because hosted cognition is what is being bought and it cannot reason about what it has not been sent. Excluding that excerpt from training is part of the release terms. The crossing path described below sends locally encrypted character ciphertext to a storage provider the studio configures.</p>

                    <h3>3.4 Ghost</h3>
                    <p>Procedural and adaptive systems can outrun manually authored test paths. Ghost, the internal harness, already drives test worlds during Servitor™ qualification. Its reports on dead ends, unreachable content and social-loop coverage are the map a producer outside this building acts on.</p>

                    <h3>3.5 The Character Intelligence Standard</h3>
                    <p><strong>Already in hand, inside ForbocAI’s own worlds:</strong> Servitor™ through the ForbocAI NPC Protocol; TypeScript and native Unreal Engine 5 interfaces; memory writes to studio-controlled local storage; structured action proposals; reply checks; action checks; internal test worlds; and an exact model and runtime build recorded internally.</p>
                                        <p id="wp-gates"><strong>Every category is bought on a measurement, and somebody writes it.</strong> The Character Intelligence Standard is the twenty-five terms on which a character model is released into a world — ours first, every rival’s on the same terms. Use it on us. Then use it on whoever pitches you next.</p>
                                        <p><strong>Each term is a door, and the first worlds through it put their names on it.</strong> Each rests on the ones beneath it: outage behavior, certification and continuity before a title ships; a named rival before a persona is scored; a price before a studio pays; a Soul carried between two live worlds before $FAI carries it. The worlds that come through first are welcomed in, and what they build opens the next.</p>
                    <ol class="gate-ledger">
                        ...
                        <li><strong><span class="gate-n">24.</span> Souls cross.</strong> $FAI carries one Soul, minted and restored, between two live titles.</li>
                ...
                <section id="wp-souls">
                    ...
                    <p><strong>A card preserves who a character is. A Soul carries who she becomes with you.</strong> Trading cards prove the appetite, a $7.8&nbsp;billion market on its way to <a href="https://www.globenewswire.com/news-release/2025/06/05/3094288/28124/en/Trading-Card-Games-Analysis-Report-2025-A-Global-11-8-Billion-Market-by-2030-Driven-by-New-Card-Releases-High-Prices-of-Advanced-TCG-Packs-and-Broad-Age-Appeal-Through-Diverse-Game.html" target="_blank" rel="noopener noreferrer">$11.8&nbsp;billion by 2030</a> — identity, strategy, collecting, and a cast that grows across releases. People pay for identity they can keep, and a card never remembers them back.</p>
