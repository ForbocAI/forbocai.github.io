            ...
            <div class="doc-body">
                ...
                <section id="wp-layer">
                    ...
                    <ol class="gate-ledger">
                        ...
                        <li><strong><span class="gate-n">14.</span> Cast separation.</strong> Clears when a cast of four hundred — the number this paper claims — is measured staying distinct from one another. Holding one authored person under pressure is a different property from keeping four hundred of them apart.</li>
                        ...
                        <li><strong><span class="gate-n">18.</span> Dialogue and action agreement.</strong> Clears when the rate at which a reply promises what the studio's rules then reject is measured and published. An action refused after the line is already spoken is the most common shipped failure of this whole product category, and it was missing from this list.</li>
                        <li><strong><span class="gate-n">19.</span> Per-scene deadlines.</strong> Clears when a studio can set its own budget per scene instead of inheriting one server-side number. We disclose this elsewhere; disclosing without numbering it was the method applied unevenly.</li>
                        ...
                        <li><strong><span class="gate-n">21.</span> The measurement as moat.</strong> Clears when a party that is not ForbocAI uses our instrument to make a purchasing decision. A published methodology open to rivals is a standard rather than a secret, and we would not want the other kind: a measurement nobody else will run measures nothing. We argue that whoever writes a category's measurement writes its purchasing criteria; by our own rule that is a strength without a gate, which is a well-worded yes. So it gets a number, and the honest mechanism is narrow: a publisher adopts a vendor's axes only when they are published before the results, run against a cast the vendor did not author, and open to a rival's model on the same terms. All three are conditions on us, not on them.</li>
                        <li><strong><span class="gate-n">22.</span> A studio pays.</strong> Clears when a studio that is not ForbocAI pays for character judgments in ordinary money. Every other gate here is engineering, and this is the one that asks whether anyone buys it — which makes leaving it off, as we had, the largest well-worded yes on the page.</li>
