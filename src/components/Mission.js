...
export const Mission = () => {
    ...
    <section id="mission" class="chapter chapter-day mission">
        <div class="container">
            ...
            <p class="mission-destination"><strong>Every company gets one destination. We are standing in ours: a world that keeps living after you walk out of the room.</strong> The innkeeper deciding what a latecomer is owed. The miner who speaks up for a debt nobody asked him to mention. The child still deciding what your choice made you. Four hundred of them, not one repeating.</p>
