    ...
    <section id="mission" class="chapter chapter-day mission">
        <div class="container">
                ...
                <div>
                    ...
                    <div class="mission-turn">
                        ...
                        ${Deeper({
                            ...
                            body: `<p><strong>Open-ended intelligence is a spring nobody owns.</strong> It is already running, and it reaches your world whether anyone cuts a course or not. Servitor™ is that water arriving as your person instead of as itself. The Protocol is the channel. Both are ours.</p>
            ...
            <div class="chapter-body">
                <p class="mission-opening"><strong>Every other surface of a game is alive. The people are not.</strong> They run out of script the moment a player asks something nobody wrote.</p>
