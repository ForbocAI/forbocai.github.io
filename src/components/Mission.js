...
export const Mission = () => {
    ...
    <section id="mission" class="chapter chapter-day mission">
        <div class="container">
            ...
            <p class="mission-destination"><strong>Our Mars is a world with no non-player characters in it.</strong> Not better dialogue. Not more lines. The end of a word that defines a person by what they are not — and on the other side of it, every figure in every scene is someone. The innkeeper who decides what a latecomer is owed. The captain who disobeys because the loyalty she was authored with outweighed the order in front of her. The child who remembers which side you took and is still deciding what that makes you.</p>

            <div class="mission-turn">
                <p class="mission-turn-label">The category: Character Intelligence</p>
                <p><strong>We did not build this and we do not own it.</strong> Open-ended intelligence is a spring already running, and it reaches your world whether anyone cuts a course or not. Servitor™ is that water arriving as your person instead of as itself. The Protocol is the channel.</p>
                ...
                <p>Branch content is the most expensive writing in the building. Hundreds of thousands of words, written, revised, localized, often performed — and a player walks one path through a tree you paid to build whole. The character they quote afterwards is rarely the one who got the budget. The tree costs more with every line of depth and never once gets taller.</p>
                <p><strong>Everyone else is making the model more itself. We took the self out.</strong> A general model arrives with a homeland it will defend — its own voice, its own agreeableness, its own opinions — and wears your character over the top. Servitor™ has no homeland to defend. The self goes quiet and someone else comes through.</p>
            ...
            <p class="mission-felt"><strong>Full strength is a whole settlement and no two of them alike:</strong> a captain who disobeys because the loyalty she was authored with outweighed the order in front of her; a town that receives a player differently in the spring because of the winter they walked away from. Servitor™ supplies the decision; your faction system still rules what it costs. That world is not a forecast. The model at the center of it is already reasoning.</p>
            <p class="mission-felt">The first cast that answers the question nobody wrote becomes the reference for a decade, and every trailer after it gets measured against the scene where a character said no for a reason the player could name — yours included, whether or not you are in it. You have the writers for that. What you have never had is a way to get it on purpose.</p>
        </div>
    </section>
    `;
};
