...
const RUNGS = [
    ...
    },
    {
        ...
        body: 'Personality as configuration, not content — four independent dials composing sixteen profiles of one vessel that has no self of its own to leak into them.',
    },
    {
        key: 'building',
        state: 'Q4 2026',
    ...
    {
        key: 'building',
        state: 'In build, undated',
        title: 'She can be carried out',
        body: 'A Soul gathers identity, memory and relationships into something that survives leaving your game. Queued behind Ghost, and we are not dating it until Ghost lands.',
    },
    {
        key: 'destination',
