    ...
    <section id="mission" class="chapter chapter-day mission">
        <div class="container">
            ...
            <div class="mission-turn">
                ...
                <p>Branch content is the most expensive writing in the building. Hundreds of thousands of words, written, revised, localised, often performed — and a player walks one path through a tree you paid to build whole. The character they quote afterwards is rarely the one who got the budget. The tree costs more with every line of depth and never once gets taller.</p>
                <p><strong>Everyone else is making the model more itself. We took the self out.</strong> A general model arrives with a homeland it will defend — its own voice, its own agreeableness, its own opinions — and wears your character over the top, which is why a cast of a hundred sounds like one actor doing accents. Servitor™ has no homeland to defend. The self goes quiet and someone else comes through.</p>
